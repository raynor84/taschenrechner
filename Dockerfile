...
# Copy PHP-FPM config to allow cross-container FastCGI access (named to load after zz-docker.conf)
COPY ./php/conf.d/php-fpm.conf /usr/local/etc/php-fpm.d/zzz-custom.conf
